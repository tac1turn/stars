            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Stuff</span></h1>
                    </li>
                </ul>
                                ...
                                <div class="card-body pb-3">
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <?php
                                                $query = "SELECT id, name, total FROM barang";
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['name']; ?></td>
                                                        <td><?= $row['total']; ?></td>
                                                        <td><a href="stuff-details.php?id=<?= $row['id']; ?>" class="btn btn-outline-info btn-rounded btn-sm">Detail</a></td>
                                                    </tr>
                                                <?php
                                                }
                                                ?>
