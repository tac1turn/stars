...
<body>
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="auth-login.php" method="POST">
                ...
                <div class="mt-3 d-flex">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn ms-auto" name="submit">SIGN IN</button>
                </div>
              </form>
            </div>
          </div>
  ...
  <?= isset($_GET["login-failed"]) ? "<script>alert('Email atau password Anda salah. Silahkan coba lagi!')</script>" : ""; ?>
</body>
